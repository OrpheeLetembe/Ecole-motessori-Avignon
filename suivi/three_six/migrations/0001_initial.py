    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_2', models.CharField(default='SOIN DU MILEU INTERIEUR', max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('letter_a', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='A')),
                ('letter_b', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='B')),
                ('letter_c', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='C')),
                ('letter_d', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='D')),
                ('letter_e', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='E')),
                ('letter_f', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='F')),
                ('letter_g', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='G')),
                ('letter_h', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='H')),
                ('letter_i', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='J')),
                ('letter_k', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='K')),
                ('letter_l', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='L')),
                ('letter_n', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='N')),
                ('letter_o', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='O')),
                ('letter_p', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='P')),
                ('letter_q', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='Q')),
                ('letter_r', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='R')),
                ('letter_s', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='S')),
                ('letter_t', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='T')),
                ('letter_u', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='U')),
                ('letter_v', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='V')),
                ('letter_w', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='W')),
                ('letter_x', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='X')),
                ('letter_y', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='Y')),
                ('letter_z', models.CharField(choices=[('Pas présentée', 'Pas présentée'), ('Présentée', 'Présentée'), ('Entendue', 'Entendue'), ('Lue', 'Lue'), ('Ecrite', 'Ecrite')], max_length=100, verbose_name='Z')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.students')),
            ],
            options={
                'verbose_name': 'Lettre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_5', models.CharField(default='MUSIQUE', max_length=100)),
